...
function typeOfData (data, callback) {
    callback(data);
};

typeOfData("Soy un string",(data) => {
    console.log(data);
...
const operacion = (num1, num2, opCB) => {
    opCB(num1, num2);
};

//suma
operacion(5,5,(operando1, operando2) => {
...
//multiplicacion
const multiplicacion = (operando1, operando2) => {
    console.log(operando1 * operando2)
}
...
const ordenSuperior = (string, callback) => {
    console.log(callback(string));
};

ordenSuperior("Pejelagarto",(str)=>{
